...
const features = [
  {
    ...
    description: "Add destinations with beautiful imagery and organize your trips with ease",
  },
  {
    icon: Calendar,
    title: "Day-by-Day Itinerary",
    description: "Plan activities for each day with precise timing and detailed descriptions",
  },
  {
    icon: Compass,
    title: "Smart Recommendations",
    description: "Get personalized suggestions for activities and places based on your interests",
  },
  {
    icon: Share2,
    title: "Easy Sharing",
    description: "Share your itineraries with travel companions with a single click",
  },
  {
    icon: Sparkles,
    title: "Beautiful Design",
    description: "Enjoy a clean, elegant interface that makes planning a pleasure",
  },
  {
    icon: Map,
              ...
              return (
                ...
                >
                  ...
                  <CardContent className="p-8 relative">
                    {/* Enhanced Icon */}
                    <div className={`rounded-2xl bg-gradient-to-br ${gradients[index]} w-16 h-16 flex items-center justify-center mb-6 shadow-lg group-hover:shadow-xl group-hover:scale-110 transition-all duration-300`}>
                    ...
                    {/* Decorative element */}
                    <div className={`absolute bottom-0 left-0 h-1 w-0 bg-gradient-to-r ${gradients[index]} group-hover:w-full transition-all duration-500`} />
                  </CardContent>
                </Card>
              )
            })}
